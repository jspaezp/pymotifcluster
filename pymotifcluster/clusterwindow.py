...
def Build_blosum_distance_dict(sequences, verbose = True, scoringmatrx = scoringMatrices.blosum62):
    """
    ...
    Parameters
    ----------
    sequences a list of strings interpretable as sequences
    scoringmatrx: a scoring matrix object as implemented by biopython (defaults to blosum62)
    ...
    for x in my_dict.keys():
        for y in my_dict[x].keys():
            ...
            my_dict[x, y] = pairwise2.align.localdx(x, y, scoringmatrx, score_only = True)
